class EventsDataset < Dataset::Base
  ...
  def load
    ...
    create_event("New Year's Day", Date.civil(Date.today.year,1,1), :description => "New Year's Party", :location => "Swanky Hotel", :start_time => Time.local(2009,1,1,0,0,0))
    ...
    create_event("Independence Day", Date.civil(Date.today.year,7,4), :description => "Fireworks", :location => "Down by the river", :category => "Holidays", :start_time => Time.local(2009,7,4,20,0,0))
  end
